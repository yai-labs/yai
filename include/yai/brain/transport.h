...
#include <yai/brain/errors.h>
#include <yai/brain/types.h>

#ifdef __cplusplus
extern "C" {
#endif

typedef enum yai_mind_protocol_kind {
...
} yai_mind_protocol_kind_t;

typedef struct yai_mind_protocol_request {
  yai_mind_protocol_kind_t kind;
  char provider[32];
  char payload[512];
} yai_mind_protocol_request_t;

typedef struct yai_mind_protocol_response {
  int status;
  int code;
  char payload[512];
} yai_mind_protocol_response_t;
