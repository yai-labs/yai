...
#include <yai/uapi/audit.h>
#include <yai/uapi/fanotify.h>
...
extern void __audit_bprm(struct yai_binprm *bprm);
...
extern int __audit_log_bprm_fcaps(struct yai_binprm *bprm,
...
static inline void audit_bprm(struct yai_binprm *bprm)
{
	if (unlikely(!audit_dummy_context()))
		__audit_bprm(bprm);
}
...
static inline int audit_log_bprm_fcaps(struct yai_binprm *bprm,
				       const struct cred *new,
				       const struct cred *old)
{
	if (unlikely(!audit_dummy_context()))
