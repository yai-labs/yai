...
Normative contracts are defined in `deps/law` and are not superseded by implementation.
...
- pinned `deps/law` commit (and tag if available)

Release notes must include:

- `yai` version
- pinned `deps/law` commit/tag
