...
Normative contract behavior (protocol/control/graph/vault/compliance) is defined in **`deps/law/`**. Contract issues may be triaged here but the source-of-truth fix may live in `law`.
