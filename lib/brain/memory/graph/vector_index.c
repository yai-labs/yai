...
static yai_mind_vector_item_t g_items[YAI_MIND_VECTOR_CAP];
...
{
  size_t i;
  if (!yai_mind_node_id_is_valid(node_id) || !values || dim == 0 || dim > YAI_MIND_VECTOR_MAX_DIM) {
...
void yai_mind_graph_vector_reset(void)
{
