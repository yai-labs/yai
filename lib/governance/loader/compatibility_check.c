...
int yai_governance_compatibility_check(yai_governance_runtime_t *rt, char *err, size_t err_cap) {
  ...
  if (yai_governance_require_file(rt, "classification/classification-map.json", json, sizeof(json)) != 0 ||
      ...
      yai_governance_require_file(rt, "domain-specializations/index/specializations.descriptors.index.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/index/specialization.matrix.v1.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/schema/specialization-descriptor.v1.schema.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/schema/specialization-registry-entry.v1.schema.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/schema/specialization-matrix-entry.v1.schema.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/templates/specialization.descriptor.template.v1.json", json, sizeof(json)) != 0 ||
      yai_governance_require_file(rt, "domain-specializations/templates/specialization.bundle.template.v1.json", json, sizeof(json)) != 0 ||
