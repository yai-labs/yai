...
int yai_governance_extract_workspace_context(const char *payload, char *out_mode, size_t out_mode_cap,
...
int yai_governance_domain_merge_apply(yai_governance_discovery_result_t *discovery,
                               char *err,
                               size_t err_cap);
