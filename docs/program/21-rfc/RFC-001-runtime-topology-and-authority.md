...
- Spec anchors (if any): `deps/yai-law/foundation/axioms/A-002-authority.md`, `deps/yai-law/foundation/boundaries/L1-kernel.md`, `deps/yai-law/foundation/boundaries/L2-engine.md`
