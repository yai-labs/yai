...
- Spec anchors (if any): `deps/law/foundation/axioms/A-002-authority.md`, `deps/law/foundation/boundaries/L1-kernel.md`, `deps/law/foundation/boundaries/L2-engine.md`
