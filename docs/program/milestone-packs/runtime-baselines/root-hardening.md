...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.0.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.1.md`
**Claim IDs:** `C-ENVELOPE-HANDSHAKE-REQUIRED`, `C-DOMAIN-COVERAGE-NETWORK`
**Mandatory evidence commands:**
- `tools/bin/yai-verify`
- `tools/bin/yai-suite`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.2.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.3.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.4.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.5.md`
