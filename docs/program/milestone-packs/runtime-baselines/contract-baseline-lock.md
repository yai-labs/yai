...
2. Specs refactor foundation (`docs/program/milestone-packs/runtime-baselines/specs-refactor-foundation.md`).
3. Root hardening (`docs/program/milestone-packs/runtime-baselines/root-hardening.md`).
...
- Next runbook: `docs/program/milestone-packs/runtime-baselines/specs-refactor-foundation.md`
