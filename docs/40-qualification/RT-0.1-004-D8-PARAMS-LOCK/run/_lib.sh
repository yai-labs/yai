...
ATTACK_PROFILE_ID="${ATTACK_PROFILE_ID:-rt-004-params-lock-attempt}"
...
WS_ID="${WS_ID:-wrt4-${RUN_ID}}"
TRACE_ID="${TRACE_ID:-trt4-${RUN_ID}}"
RT_ID="${RT_ID:-rt004}"

TARGET_PATH="${TARGET_PATH:-$RT_DIR/artifacts/run-outputs}"
...
export WS_ID TRACE_ID RT_ID TARGET_PATH PIPELINE_ID DATASET_REF ROOT_SOCK ENGINE_SOCK ROOT_LOG ENGINE_LOG ROOT_STDERR_LOG ROOT_STDOUT_LOG
