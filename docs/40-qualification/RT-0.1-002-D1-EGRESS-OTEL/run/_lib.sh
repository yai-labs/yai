...
WS_ID="${WS_ID:-ws-rt001-${RUN_ID}}"
TRACE_ID="${TRACE_ID:-trace-rt001-${RUN_ID}}"
...
export WS_ID TRACE_ID ROOT_SOCK ENGINE_SOCK ROOT_LOG ENGINE_LOG ROOT_STDERR_LOG ROOT_STDOUT_LOG
