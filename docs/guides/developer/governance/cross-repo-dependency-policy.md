...
- `governance`: normative authority source. Defines governance/contracts/registries/schemas.
...
- `compatibility declaration`: explicit statement of supported governance/sdk/cli surface versions without structural dependency.
...
4. If a relation changes, update matrices in:
   - `docs/guides/developer/governance/cross-repo-responsibility-matrix.md`
