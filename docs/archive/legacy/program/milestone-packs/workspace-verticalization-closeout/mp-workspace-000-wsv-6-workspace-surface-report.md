...
updated: 2026-03-10
scope: [yai, yai-governance, yai-cli, yai-sdk]
related:
  - docs/archive/legacy/program/milestone-packs/runtime-baselines/workspace/mp-runtime-000-command-taxonomy.md
  - docs/archive/legacy/program/milestone-packs/runtime-baselines/workspace/mp-runtime-000-command-mapping.md
...
- `yai-governance` registry command truth,
...
- WSV-3 governance canonicalization,
...
- Matrix: `docs/archive/legacy/program/reports/workspace-verticalization-report.md`
- Manual pack: `docs/archive/legacy/program/reports/workspace-verticalization-report.md`
...
Rationale:
- canonical workspace-first surface is implemented and aligned across runtime/governance/cli/sdk,
