...
- Customer-grade remote owner/peer operation requires secure peering baseline per
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/workspace/mp-runtime-000-secure-peering-deployment-runbook.md`.
...
- YD-1 topology lock and naming baseline are documented in
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/distributed-runtime/mp-runtime-000-daemon-architecture-runbook.md`.
...
- RF-0.2 policy hierarchy lock baseline:
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/distributed-runtime/mp-runtime-000-policy-hierarchy-runbook.md`.
- RF-0.3 delegated edge enforcement baseline:
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/distributed-runtime/mp-runtime-000-delegated-edge-enforcement-runbook.md`.
- RF-0.4 process and asset runtime observation baseline:
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/data-runtime/mp-runtime-000-observation-runbook.md`.
- ER-2 edge state/spool/retry/health baseline:
  `docs/archive/legacy/program/milestone-packs/runtime-baselines/distributed-runtime/mp-runtime-000-state-spool-retry-runbook.md`.
