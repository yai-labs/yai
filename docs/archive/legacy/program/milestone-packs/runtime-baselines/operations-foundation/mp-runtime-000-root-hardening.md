...
- [x] `../governance` protocol headers are present and treated as source-of-truth.
...
- `../governance` headers are present and treated as source-of-truth
...
**Milestone Pack:** `docs/archive/legacy/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-5.md`
...
- `../governance/contracts/protocol/include/auth.h`
- `../governance/contracts/protocol/include/roles.h` (if present)
...
- `../governance/contracts/protocol/include/transport.h` (static inline validator)
...
- `docs/archive/legacy/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-5.md`
- `docs/archive/legacy/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-5.md`
- `docs/archive/legacy/program/milestone-packs/root-hardening/README.md` (`MP-ROOT-HARDENING-INDEX`)
