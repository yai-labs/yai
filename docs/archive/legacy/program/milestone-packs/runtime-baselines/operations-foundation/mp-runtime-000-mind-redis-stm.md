...
- Runbooks: `docs/archive/legacy/program/milestone-packs/runtime-baselines/operations-foundation/mp-runtime-000-engine-attach.md`, `docs/archive/legacy/program/milestone-packs/runtime-baselines/data-runtime/mp-runtime-000-data-plane.md`
...
**Spec:** `../governance/storage/REDIS_KEYSPACE.md`
...
impl KernelClient {
    ...
    pub fn handshake(&mut self) -> Result<(), String> {
        ...
        // (use protocol from ../governance/contracts/protocol/include/transport.h)
