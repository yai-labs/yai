...
| SC-2 Authority State | core | review/apply lifecycle | exec, governance mappings, inspect |
| SC-3 Governance/Compliance Object State | governance-facing governance lifecycle | parsing engine, authoring surface | core, exec, workspace apply |
...
| SC-6 Resolution/Evidence Log | governance mappings + runtime resolution | exec/core | audit/debug/inspect/query, graph hooks |
...
- `docs/archive/legacy/program/milestone-packs/runtime-baselines/operations-foundation/mp-runtime-000-mind-redis-stm.md`
