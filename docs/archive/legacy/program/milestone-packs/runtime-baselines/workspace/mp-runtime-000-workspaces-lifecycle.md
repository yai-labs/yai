...
6. Contract authority stays pinned to `../governance`; local semantic drift is non-compliant.
...
See:
- `governance/docs/archive/legacy/pointers/RUNTIME_RESOLUTION.pointer.md`
