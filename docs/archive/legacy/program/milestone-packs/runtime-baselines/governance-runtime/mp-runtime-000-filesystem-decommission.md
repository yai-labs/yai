...
- `yai` (primary)
- `governance` (normative source + generated/export surfaces)
- `sdk` (dist/examples)
- `cli` (dist)
...
- `governance/grammar/**`, `governance/domains/**`, `governance/overlays/**`, `governance/manifests/governance.manifest.json`: `FS-C1` keep canonical.
- `governance/manifests/customer-policy-packs/examples/**`, `templates/**`: `FS-C2` (authoring examples/templates), never runtime truth.
- `governance/transitional/domain-family-seed/**`: `FS-C4 -> FS-C6` (archive candidate).
- `yai/governance/runtime-package/**`: `FS-C2` generated embedded export, keep as runtime package export, not governance runtime state truth.
...
Keep:
- generated embedded governance bundles needed by runtime loader (`FS-C2`).
...
- `governance`: preserve normative source; archive transitional seeds and non-canonical residues.
