...
## 8) References
- ADR: `docs/20-governance/22-adr/ADR-009-engine-attachment.md`
...
- ADR refs:
  ...
  - `docs/20-governance/22-adr/ADR-008-connection-lifecycle.md`
- MPs (planned):
  - `docs/20-governance/24-milestone-packs/engine-attach/MP-ENGINE-ATTACH-0.1.0.md` (ID: `MP-ENGINE-ATTACH-0.1.0`)
