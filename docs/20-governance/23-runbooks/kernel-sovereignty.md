...
## 8) References
- ADR: `docs/20-governance/22-adr/ADR-003-kernel-authority.md`
- Runbooks: `docs/20-governance/23-runbooks/root-hardening.md`, `docs/20-governance/23-runbooks/engine-attach.md`
...
4. Document security model in `docs/20-governance/27-security/SOVEREIGNTY.md`
