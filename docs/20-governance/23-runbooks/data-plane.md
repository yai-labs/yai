...
## 8) References
- Runbooks: `docs/20-governance/23-runbooks/root-hardening.md`, `docs/20-governance/23-runbooks/workspaces-lifecycle.md`, `docs/20-governance/23-runbooks/engine-attach.md`
...
- MPs (to be filled as phases ship): `docs/20-governance/24-milestone-packs/...`
