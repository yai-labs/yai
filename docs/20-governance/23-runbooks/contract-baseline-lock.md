...
## 2) Preconditions
- [ ] `docs/20-governance/22-adr/ADR-011-contract-baseline-lock.md` is present and traceable.
...
2. Specs refactor foundation (`docs/20-governance/23-runbooks/specs-refactor-foundation.md`).
3. Root hardening (`docs/20-governance/23-runbooks/root-hardening.md`).
...
- Milestone Pack (planned): `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.0.md`
...
- Milestone Pack: `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.1.md`
...
- Milestone Pack: `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.2.md`
...
- Milestone Pack: `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.3.md`
...
- Milestone Pack: `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.4.md`
...
- Next runbook: `docs/20-governance/23-runbooks/specs-refactor-foundation.md`
- MP track: `docs/20-governance/24-milestone-packs/contract-baseline-lock/README.md`
...
- MPs (filled as phases ship):
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.0.md`
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.1.md`
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.2.md`
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.3.md`
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.4.md`
