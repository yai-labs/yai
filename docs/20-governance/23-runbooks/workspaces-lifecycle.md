...
- `docs/20-governance/23-runbooks/workspaces-lifecycle.md` (this file; update if needed)
...
- `docs/20-governance/21-proposals/PRP-003-workspace-lifecycle-and-isolation.md`

### Milestone packs

- `docs/20-governance/24-milestone-packs/workspaces-lifecycle/MP-WORKSPACES-LIFECYCLE-0.1.0.md` *(planned)*
- `docs/20-governance/24-milestone-packs/workspaces-lifecycle/MP-WORKSPACES-LIFECYCLE-0.1.1.md` *(planned)*
