...
## 8) References
- ADR: `docs/20-governance/22-adr/ADR-005-mind-proposer.md`
- Runbooks: `docs/20-governance/23-runbooks/engine-attach.md`, `docs/20-governance/23-runbooks/data-plane.md`
