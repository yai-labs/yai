...
- Implemented by runbooks:
  ...
  - `docs/20-governance/23-runbooks/root-hardening.md` (downstream hardening)
- Milestone packs:
  - `docs/20-governance/24-milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.0.md` (planned)
