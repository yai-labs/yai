...
related:
  adr:
    - docs/20-governance/22-adr/ADR-001-single-runtime.md
    - docs/20-governance/22-adr/ADR-002-root-entrypoint.md
    - docs/20-governance/22-adr/ADR-003-kernel-authority.md
    - docs/20-governance/22-adr/ADR-004-engine-execution.md
    - docs/20-governance/22-adr/ADR-005-mind-proposer.md
  runbooks:
...
- Targets ADR: `docs/20-governance/22-adr/ADR-001-single-runtime.md`, `docs/20-governance/22-adr/ADR-002-root-entrypoint.md`, `docs/20-governance/22-adr/ADR-003-kernel-authority.md`, `docs/20-governance/22-adr/ADR-004-engine-execution.md`, `docs/20-governance/22-adr/ADR-005-mind-proposer.md`
- Downstream runbook: `docs/20-governance/23-runbooks/root-hardening.md`
- Downstream MP: `docs/20-governance/24-milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.0.md`

## References
- `docs/20-governance/spine.md`
- `docs/20-governance/traceability.md`
- `docs/20-governance/22-adr/ADR-001-single-runtime.md`
