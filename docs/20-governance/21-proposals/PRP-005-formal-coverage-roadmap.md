...
- Targets ADR: `docs/20-governance/22-adr/ADR-006-unified-rpc.md`, `docs/20-governance/22-adr/ADR-011-contract-baseline-lock.md`
- Downstream runbook: `docs/20-governance/23-runbooks/root-hardening.md`
- Downstream MP: `docs/20-governance/24-milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.5.md`
