...
| Mind | partial | `docs/design/adr/ADR-003-kernel-authority.md`, `docs/design/adr/ADR-005-mind-proposer.md` | `docs/runbooks/mind-redis-stm.md`, `docs/runbooks/root-hardening.md` | `docs/milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.5.md` | `deps/yai-specs/contracts/boundaries/L3-mind.md`, `deps/yai-specs/contracts/invariants/I-004-cognitive-reconfiguration.md` |
