...
- ADRs: `docs/20-governance/22-adr/ADR-001-single-runtime.md`, `docs/20-governance/22-adr/ADR-002-root-entrypoint.md`, `docs/20-governance/22-adr/ADR-003-kernel-authority.md`, `docs/20-governance/22-adr/ADR-004-engine-execution.md`, `docs/20-governance/22-adr/ADR-005-mind-proposer.md`
- Runbooks: `docs/20-governance/23-runbooks/root-hardening.md`, `docs/20-governance/23-runbooks/engine-attach.md`, `docs/20-governance/23-runbooks/mind-redis-stm.md`
- MPs: `docs/20-governance/24-milestone-packs/root-hardening/MP-ROOT-HARDENING-0.1.0.md`
