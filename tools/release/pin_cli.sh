...
INFRA_SCRIPT="$INFRA_ROOT/tools/release/pin_cli.sh"
LEGACY_SCRIPT="$ROOT/tools/release/.legacy/pin_cli.sh"
...
echo "ERROR: local fallback unavailable for tools/release/pin_cli.sh" >&2
exit 1
