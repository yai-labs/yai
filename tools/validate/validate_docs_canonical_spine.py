...
REQUIRED = [
    ...
    "docs/archive/legacy/architecture/governance/governance-source-policy-integration-architecture.md",
    ...
    "docs/archive/legacy/program/reports/cross-repo-convergence-report.md",
