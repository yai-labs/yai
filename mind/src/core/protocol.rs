use crate::shared::constants::{
    YAI_CMD_NONE, YAI_CMD_NOOP, YAI_CMD_PING, YAI_STATE_ERROR, YAI_STATE_HANDOFF_COMPLETE,
    YAI_STATE_HALT, YAI_STATE_PREBOOT, YAI_STATE_READY, YAI_STATE_RUNNING, YAI_STATE_SUSPENDED,
};
