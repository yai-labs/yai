...
`formal/` is the canonical mathematical and verification layer for the unified
YAI system.
...
- `schema/` formal metadata schemas
...
- `formal/` defines invariants, violation classes, and transition legality
