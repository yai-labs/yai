...
int main(void) {
  ...
  if (yai_law_read_surface_json(&rt, "contracts/control/schema/control_plane.v1.json", json, sizeof(json)) != 0) {
  ...
  if (yai_law_read_surface_json(&rt, "contracts/providers/schema/providers.v1.json", json, sizeof(json)) != 0) {
  ...
  if (yai_law_read_surface_json(&rt, "schema/workspace_governance_attachment.v1.schema.json", json, sizeof(json)) != 0) {
  ...
  if (yai_law_read_surface_json(&rt, "schema/governance_review_state.v1.schema.json", json, sizeof(json)) != 0) {
